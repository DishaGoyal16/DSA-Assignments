    ...
    do {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                break;
            case 3:
                cout << "Enter new value and the node value before which to insert: ";
                cin >> val >> key;
                list.insertBeforeAfter(val, key, false);
                break;
            case 4:
                cout << "Enter new value and the node value after which to insert: ";
                cin >> val >> key;
                list.insertBeforeAfter(val, key, true);
                break;
            case 5:
